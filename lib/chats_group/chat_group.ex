defmodule ChatGroup do
  ...
  def init({chat_group_id, chat_group_state}) do
    ...
    chat_group_state = %ChatGroupState{
      id: chat_group_id,
  ...
  def handle_call({:add_participant, admin, participant}, _from, {chat_group_id, chat_group_state}) do
    case find_admin(admin, {chat_group_id, chat_group_state}) do
      ...
      _admin ->
        ...
        new_state = %ChatGroupState{chat_group_state | participants: new_participants}
  ...
  def handle_call({:give_administrator_privileges, admin, participant}, _from, {chat_group_id, chat_group_state}) do
    case find_admin(admin, {chat_group_id, chat_group_state}) do
      ...
      _admin ->
        ...
        new_state = %ChatGroupState{chat_group_state | participants: new_participants, admins: new_admins}
  ...
  defp find_admin(user_id, {_, %ChatGroupState{admins: admins}}) do
    Enum.find(admins, &(&1 == user_id))
  end

  defp find_participant(user_id, {_, %ChatGroupState{participants: participants}}) do
